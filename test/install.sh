...
grep -Fq 'keybind = ctrl+shift+j=set_tab_title:__WS_REVIEW_LAST_TURN__' "$HOME/.config/ws/ghostty.conf"
! grep -Fq 'keybind = alt+q=set_tab_title:__WS_REVIEW_WORKSPACE__' "$HOME/.config/ws/ghostty.conf"
grep -Fq 'keybind = alt+k=set_tab_title:__WS_NAME_SESSION__' "$HOME/.config/ws/ghostty.conf"
